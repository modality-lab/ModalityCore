...
@MainActor
private struct SegmentedControlInsetsKey: @preconcurrency EnvironmentKey {
  static var defaultValue: EdgeInsets = .init(top: 0, leading: 0, bottom: 0, trailing: 0)
}

@MainActor
private struct SegmentedControlInterSegmentSpacingKey: @preconcurrency EnvironmentKey {
  static var defaultValue: CGFloat = .zero
}

@MainActor
private struct SegmentedControlContentStyleKey: @preconcurrency EnvironmentKey {
  static var defaultValue: CustomizableSegmentedControlContentStyle = .default
}

@MainActor
private struct SegmentedControlSlidingAnimationKey: @preconcurrency EnvironmentKey {
